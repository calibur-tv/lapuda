...
**答**：目前网站还在初始阶段，体量较小，站内有一些禁播和收费资源（包括视频和漫画）来承载产品的工具属性，这是相较于B站的优势；
...
**答**：我们会利用团子系统，将盗版资源设置成付费观看，然后将这些所得转移到版权方账户上，具体如下：
...
- 目前我们的团子是提供给个人的，以后也会提供给"社团号"，社团成员只要以"社团的名义"发表内容，就可以将团子都结算给社团号
...
### 7. 为什么要做偶像应援
- **答**：对标百度贴吧的盖楼功能，并且更加专业，排行榜的含金量更高
- 消耗用户的团子，降低提现用户的人数
- 丰富站内的内容，朝着"动漫百科"方向稍稍发展
- 为之后对标B萌功能打基础

### 8.这个社区只不过是百度贴吧、P站、豆瓣电影、知乎（未来的问答系统）的大杂烩，有什么意义吗？
**答**：氛围非常重要，B站能够快速发展，也是靠着弹幕系统提供的氛围，而弹幕系统是工具属性，社区是社交属性，我们从另一个方向为用户提供一个良好的氛围。
- 我们相比于百度贴吧，氛围更好，帖子的内容更加垂直
- P站虽然非常成功，但是由于一些原因国内无法正常访问，而B站的画友功能虽然可以供用户表达，但是用户是无法通过作品来获取到收入的，我们的团子系统能够让原创作品为作者带来收入
- 豆瓣电影只是电影的评分，动漫的评分氛围很差，一方面是豆瓣的用户群体年龄段偏高，另一方面是动漫的评分与电影的评分有着本质的区别
- 知乎的氛围并不适合讨论动漫，动漫是一种"天真的东西"，而知乎的用户年龄段稍微高一些，更在乎"理"，导致大部分架空性的动漫作品在知乎没有讨论的土壤

这些功能的存在场景是及其普遍而又独立的：
- 当我忽然对某个动漫的剧情有灵感时，我可以发布一篇帖子，当我得知了某部动漫的最新资讯后，我也可以发布一篇帖子，这是非常普遍的场景
- 也许我对动漫的资讯并不感冒，只是喜欢一些动漫人物，并且喜欢画画，那么相册就是一个非常好的表达途径
- 当一部番完结了，我想对他做出评价，留作纪念，那么漫评就是一个常见的场景
- 《海贼王》新的一话出了，话题又被引爆了，大家都对这一集的内容进行分析，并且预测之后的发展，这就是一个问答场景

将这些场景都涵盖在社区里，为用户提供不同的表达渠道，这样的网络社区才贴近于一个真实世界的社区，它不应该是单一的，而是丰富多彩的

### 9.将原本归属于不同年龄段的功能聚集到一个产品里，这样的一个社区该如何管理？
**答**：对用户进行有效的分层，满足不同用户的诉求才能将社区管理好
- 反面的例子：视频弹幕里可能有十几岁的小孩发表的内容，也可能有二三十岁的用户发表的内容，这些用户面对同样的场景，感悟本身就是千差万别，导致用户之间
冲突不断才是普遍的，一旦官方偏向了一方的价值观，另一方必将受到压迫，但是到底谁是对的呢？很明显十几岁小孩说出的话，就符合小孩的认知，成年人说的话，就符合他的认知，
只是对世界的认识不同，并没有绝对的对与错来划分，但肯定会有矛盾
- 因此将社区管理好，最方便的方法就是为用户进行分层，给不同年龄段的用户提供不同的表达渠道
    - 帖子功能更多的会偏向资讯和灵感，天生的门槛低，也天生的难有高质量内容，所以这部分是适合低年龄段用户的
    - 为了让有高年龄段用户有表达的渠道，我们开发出门槛较高的相册功能和漫评功能
    - 通过表达成本来过滤用户，达到用户分层的目的
    - 整个番剧板块是由吧主管理，和百度贴吧相同
    - 因此充斥着大量低价值观的帖子，就可以交给吧主来过滤，审核
    - 而专业度较高的漫评，只要有基本的内容审核再加上举报渠道就可以保证内容的质量
    - 问答功能更偏向于理智，这部分需要严格的规则来约束答题者，也可以营造一个良好的氛围
- 将不同年龄段、价值观的用户集中在不同的板块里，各自表达自己的想法，互不干扰，这样就能让社区在用户群体丰富的同时保持和谐，一定要做好**分层**

### 10. 如果用户只对单个板块感兴趣，而不喜欢其它几个板块该怎么办？
**答**：之后会开发出让不同用户自定义板块的功能，将不喜欢的可以隐藏，他就永远不会看到被自己屏蔽的板块的内容

### 11. 1团子=1人民币，如果用户达到千万，那一天不是要烧上千万？
**答**：目前 1团子=1人民币，和Q币相同。用户每日签到就可以获得一枚团子，用户邀请他人注册，每注册1人他就得到一枚团子
- 从一开始我就考虑到这个问题，也有了答案，只是这个答案偏向于理想化，它的规则有点像**比特币**
- 在用户量少的情况下，只需要提供100团子的提现门槛，就可以挡住绝大部分普通用户来提现，能在短期内提现的基本都是能够产生优质内容的人
- 我们也是为了吸引优质内容创作者，才开发的团子系统，确实它能达到目的，它的场景如下：
    - 用户为了尽早提现，于是发布优质内容到站内（用户被激励创作）
    - 而一开始站内用户少，大家团子也少，所以他也很难靠优质内容提现
    - 他选择分享自己的邀请码给别人，并让别人给他点赞，这样就可以很快提现了
    - 这就是目前团子存在的逻辑
- 等用户量大了之后，势必会压垮公司，因此我们需要改变规则
    - 团子的汇率仍然是 1团子=1人民币
    - 团子不能提现
    - 团子不能提现了，那汇率不是骗人吗？我们可以通过团子兑换**商城里的实物**
        - 假设一顶帽子的批发价是 10 元，零售价是 15 元，然而只要加入了二次元的元素，一般可以卖到 25 元
        - 我们商城里的物品，假设出售价是 20 元，低于其他二次元商城（用户感觉到便宜），但是高于普通商铺（这个差价就是情怀价）
        - 但是我们可以用10个团子和10元钱购买这顶帽子
        - 也就是说，这顶帽子，仍然是批发价出售，但是消耗了用户10枚团子，这10枚团子，就是10元钱
        - 也句是说，如果使用了团子，我们就不赚钱了，只是一个中间转发，如果不使用团子来购买，我们就可以赚钱
        - 所以这个时候，团子的汇率就被我们保留了下来，但是它并不值钱
        - 为什么我们的商品可以比其他二次元商铺低那么一点？因为我们也不需要通过商城赚钱，商城的一部分价值就是**代表团子的汇率**
- 以上规则适用于普通用户，不适用于大V，因为大V会有几万几十万的团子，而并没有那么高的购买力，而我们团子的存在就是为了刺激用户发表高质量内容，所以团子的规则仍然需要调整
    - 通过商城保持团子汇率 1团子=1人民币的同时，将团子做成一个"池子"
    - 将现在的钱转化为未来的钱支付给用户，也就是股份，解释如下：
        - 假设网站有100个用户，每个人有2个团子，就是200个团子
        - 这200个团子代表了公司的 20% 的股份，也就是说每个用户都持股 0.1%
        - 当用户交换团子时，每个人的持股量再变动
        - 当网站有1000个用户，每个人有200个团子，总数20万枚
        - 如果你有10枚团子，那么你持有的股份就少的可怜，虽然你手上的团子更多了
    - 这样的规则会导致这样的场景：
        - 用户基数少的时候，大家团子都少，然后你的团子虽然少，但是占的份额多，然而因为用户少，所以股份不值钱，所以你手上的团子也不值钱
        - 随着用户基数增大，你的团子如果不增长，那么你所持有的就会越来越少，但是网站在发展，你的占比少了，但是价值高了
        - 随着用户增长，如果你的团子也在持续增加，那么就要看你的团子占总团子池的比例的变化情况，这个时候网站用户多了，股份也值钱了，你就能获得更多的收益
    - 这造成的结果就是：
        - 想要让自己的收益越来越多，就要不断的去发表高质量的内容，吸引更多的用户注册，吸引更多的用户给你团子
        - 然而最后拥有最多团子的人，不是来的最早的那个人，而是能够产生更多优质内容的人
        - 为了避免马太效应，我们会在内容推荐上，对新人更友好，这样就可以一直保持社区的高活跃了
- 以后的团子系统会在某个合适的时间点升级成上面的这种模式，至于这池子所占的股份到底是多少，要看具体的情况，当然，是以期权的形式由我个人代持，然后最终分发给用户

### 12. 未来的商业模式都是什么样的？
**答**：未来的商业模式还没有太创新的思路，目前有这几种：
- 会员系统，保证现金流（拟 1个月会员=30元，每天签到双倍团子等价值），不需要盈利
...
- 如果会员每天都反还团子，这样用户其实是不花钱，那么大家都愿意充这个团子，但是这个钱可以保留在公司账上，作为现金流让公司活下去
- 营造出良好的企业形象，不收用户一分一毫

### 14. 电商系统相比于其它电商有什么优势？
**答**：电商系统的存在，不仅仅是为了赚钱，并且电商这方面的市场会在未来几年更大
- 如上面所说的，电商的存在一个原因是为了刺激用户，让用户怼团子的汇率保持信心
- 另一个作用就是："买家秀"也是一个重要的社交场地
    - 我们可以将买家秀和相册功能联动起来
    - 只要用户购买了我们商店里的东西，并且建了一个相册专门 show 这次购物的体验
    - 比如说拆箱过程、上手体验等
    - 然后，只要用户能够集齐商品价格的团子数，我们就可以反还一定金额给用户（等量的团子被扣掉），这样用户认为四舍五入买东西不花钱了
    - 但其实，给买家投硬币的人里面，可能是会员玩家，我们只是将一个人的钱兑换给了另一个人，我们没有损失，但是促进了社交发展
    - 更多的人会养成在商城里购物的习惯
- 而且我们的产品是强社交的，因此可以开发出：一群用户众筹给另一个用户买商品的情况，这些都是社交行为
- 因此我们的商城，是承载了社交属性的，也正因为它有社交属性，所以我们的价格可以依靠团子系统打的更低
...
- 之后的推广，会在三个月至半年内权力奔跑
    ...
    - 根据之前多次推广的经验发现，大部分人对团子系统可提现是不信任的，因为我们是个人，而不是公司，我们无法做出承诺
    ...
    - 其它地方，QQ兴趣部落，QQ群，基本的套路都是："给予管理者足够的利益"，而这利益，就是团子了。
- 最终预计1年内增长到500万用户
- 可分配给用户真实提现的金额会控制在50万以内，超出之后就更改团子规则
- 更改团子规则之前，不对外做产品宣讲会，更改规则之后，开始吸引更多的社会目光，达到曝光的目标
- 在这段时间内，研发会非常的辛苦，需要应对很多问题，产品更迭的速度也要快，过了这个坎，产品就稳定了
- 因此，融资后，会先有1个月左右的调整期，然后会有三个月至半年的高速增长期，这之后用户提现金额达到我们心理预期，就开始升级团子系统，开始
