...
- P站虽然非常成功，但是由于一些原因国内无法正常访问，而B站的画友功能虽然可以供用户表达，但是用户是无法通过作品来获取到收入的，我们的金币系统能够让原创作品为作者带来收入
...
### 11. 1金币=1人民币，如果用户达到千万，那一天不是要烧上千万？
**答**：目前 1金币=1人民币，和Q币相同。用户每日签到就可以获得一枚金币，用户邀请他人注册，每注册1人他就得到一枚金币
- 从一开始我就考虑到这个问题，也有了答案，只是这个答案偏向于理想化，它的规则有点像**比特币**
- 在用户量少的情况下，只需要提供100金币的提现门槛，就可以挡住绝大部分普通用户来提现，能在短期内提现的基本都是能够产生优质内容的人
- 我们也是为了吸引优质内容创作者，才开发的金币系统，确实它能达到目的，它的场景如下：
    - 用户为了尽早提现，于是发布优质内容到站内（用户被激励创作）
    - 而一开始站内用户少，大家金币也少，所以他也很难靠优质内容提现
    - 他选择分享自己的邀请码给别人，并让别人给他点赞，这样就可以很快提现了
    - 这就是目前金币存在的逻辑
- 等用户量大了之后，势必会压垮公司，因此我们需要改变规则
    - 金币的汇率仍然是 1金币=1人民币
    - 金币不能提现
    - 金币不能提现了，那汇率不是骗人吗？我们可以通过金币兑换**商城里的实物**
        - 假设一顶帽子的批发价是 10 元，零售价是 15 元，然而只要加入了二次元的元素，一般可以卖到 25 元
        - 我们商城里的物品，假设出售价是 20 元，低于其他二次元商城（用户感觉到便宜），但是高于普通商铺（这个差价就是情怀价）
        - 但是我们可以用10个金币和10元钱购买这顶帽子
        - 也就是说，这顶帽子，仍然是批发价出售，但是消耗了用户10枚金币，这10枚金币，就是10元钱
        - 也句是说，如果使用了金币，我们就不赚钱了，只是一个中间转发，如果不使用金币来购买，我们就可以赚钱
        - 所以这个时候，金币的汇率就被我们保留了下来，但是它并不值钱
        - 为什么我们的商品可以比其他二次元商铺低那么一点？因为我们也不需要通过商城赚钱，商城的一部分价值就是**代表金币的汇率**
- 以上规则适用于普通用户，不适用于大V，因为大V会有几万几十万的金币，而并没有那么高的购买力，而我们金币的存在就是为了刺激用户发表高质量内容，所以金币的规则仍然需要调整
    - 通过商城保持金币汇率 1金币=1人民币的同时，将金币做成一个"池子"
    - 将现在的钱转化为未来的钱支付给用户，也就是股份，解释如下：
        - 假设网站有100个用户，每个人有2个金币，就是200个金币
        - 这200个金币代表了公司的 20% 的股份，也就是说每个用户都持股 0.1%
        - 当用户交换金币时，每个人的持股量再变动
